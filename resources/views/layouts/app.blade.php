...
<head>
    ...
    <title>{{ config('app.name', 'GOLFSTATION') }}</title>
    ...
    <!-- Styles -->
    <link rel="icon" href="{{ URL::asset('photo/L.png') }}" type="image/x-icon"/>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">   
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <div class="d-flex">
                        <div><img src="{{ asset('photo/L.png') }}" style="height:50px;" alt=""></div>
                        <div class="pl-3 ml-3 pt-2" style="border-left:1px solid rgba(0, 0, 0, 0.5); font-size:1.5rem;">{{ config('app.name', 'Golf Station') }}</div>
                    </div>
                </a>
            ...
            <div class='container p-0 pt-3'>
                <div class='row'>
                    <div class='col-md-4 col-sm-12 pt-3'>
                        ...
                        <p>Golf Station <br> Pondok Indah <br> +6281874536 <br> customercare@golfsation.com</p>
                    </div>
                    <div class='col-md-4 col-sm-12 pt-3'>
                        <h3>Follow Us On</h3>
                        <ul>
